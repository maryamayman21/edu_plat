...
import 'package:edu_platt/presentation/courses/presentaion/widgets/student_success_widget.dart';
...
class StudentHomeCoursesScreen extends StatefulWidget {
  const StudentHomeCoursesScreen({super.key});

  @override
  State<StudentHomeCoursesScreen> createState() => _StudentCoursesScreenState();
}

class _StudentCoursesScreenState extends State<StudentHomeCoursesScreen> with TickerProviderStateMixin {
  @override
              ...
              builder: (context, state) {
                if(state is CoursesInitial){
                  return const NoCoursesFoundWidget(
                    semesterRoute: AppRouters.studentSemesterRoute,
                  );
                }
                  ...
                  return StudentSuccessWidget(courses: state.courses);
                }

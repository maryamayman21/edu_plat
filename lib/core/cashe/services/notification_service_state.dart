...
class NotifcationCacheService {
  static final NotifcationCacheService _instance = NotifcationCacheService._internal();
  final BaseCacheService _baseCacheService = BaseCacheService();

  NotifcationCacheService._internal();

  factory NotifcationCacheService() => _instance;
